...
define('FILENAME_DEFINE_FOOTER_SUPPORT_ICONS_BRANDS', 'define_footer_support_icons_brands');
define('FILENAME_DEFINE_FOOTER_SUPPORT_ICONS_BRANDS_V3', 'define_footer_support_icons_brands_v3');
define('FILENAME_DEFINE_FOOTER_SOCIAL_NEWSLETTER_COLUMN', 'define_footer_social_newletter_column');
define('FILENAME_DEFINE_FOOTER_SOCIAL_NEWSLETTER_COLUMN_3', 'define_footer_social_newletter_column_3');
define('FILENAME_DEFINE_FOOTER_ABOUTUS_COLUMN', 'define_footer_aboutus_column');
...
define('FILENAME_DEFINE_FOOTER_CONTACTUS', 'define_footer_contactus');
define('FILENAME_DEFINE_FOOTER_SOCIAL_ICONS', 'define_footer_social_icons');
define('FILENAME_DEFINE_FOOTER_SOCIAL_ICONS_3', 'define_footer_social_icons_3');
define('FILENAME_DEFINE_HEADER_MAIN_MENU', 'define_header_main_menu');
define('FILENAME_DEFINE_HEADER_MAIN_MEGA_MENU', 'define_header_main_mega_menu');


// db : 04.11.16 - begin


define('FILENAME_WONDERLAND_STORY', 'z-palette-wonderland-story-ezp-15.html');
define('FILENAME_SHOP_INTERNATIONAL', 'http://www.zpalette.studio/develop/shop-international-ezp-16.html');
define('FILENAME_SHOP_ONLINE', 'http://www.zpalette.studio/develop/shop-online-ezp-17.html');
define('FILENAME_AMAZON_RETAILERS', 'http://www.zpalette.studio/develop/authorized-amazon-retailers-ezp-18.html');
define('FILENAME_VIDEO', 'http://www.zpalette.studio/develop/video-ezp-19.html');
define('FILENAME_CRYSTAL_Z', 'http://www.zpalette.studio/develop/crystal-z-palette-ezp-20.html');
