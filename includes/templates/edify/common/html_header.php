...
<meta name="author" content="Z Palette : db" />
...
<?php
require($template->get_template_dir('tpl_edify_custom_css.php',DIR_WS_TEMPLATE, $current_page_base,'common'). '/tpl_edify_custom_css.php');
?>
  <!-- db --->
  ...
  <style>
    #background {
      ...
      background-image: url( 'Vimeofy/src/assets/images/zpback1.jpg' );
