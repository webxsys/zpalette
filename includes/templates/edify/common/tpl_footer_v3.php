...
?>
<!-- Footer Home Page version 3 Wrapper -->
<div class="footer-v3-wrapper">
   	<div class="footer-v3-container">
	<?php if (!$flag_disable_footer) {
		if ($this_is_home_page){ ?>
      	<!--Support Icons - Brand Slider/Edit in Admin > Tools >Define Pages Editor >define_footer_support_icons_brands_v3.php-->
		<?php include zen_get_file_directory(DIR_WS_LANGUAGES . $_SESSION['language'] . '/html_includes/', 
            FILENAME_DEFINE_FOOTER_SUPPORT_ICONS_BRANDS_V3, 'false'); 
        ?>
    ...
    <div class="footer-wrapper">
        <div class="footer-bottom">
            ...
            <?php include zen_get_file_directory(DIR_WS_LANGUAGES . $_SESSION['language'] . '/html_includes/', 
                FILENAME_DEFINE_FOOTER_SOCIAL_NEWSLETTER_COLUMN_3, 'false'); 
            ?>
            ...
            <div id="footer-2">
                <div class="row">
                    ...
                    <!-- Information Link Column/Edit in Admin > Tools > Define Pages Editor > 
                    define_footer_information_links.php -->
                    <?php include zen_get_file_directory(DIR_WS_LANGUAGES . $_SESSION['language'] . '/html_includes/', 
            ...
            <?php include zen_get_file_directory(DIR_WS_LANGUAGES . $_SESSION['language'] . '/html_includes/', 
                FILENAME_DEFINE_FOOTER_SOCIAL_ICONS_3, 'false'); 
            ?>
...
<!-- Footer Home Page version 3 Wrapper Ends -->
<?php
	} // flag_disable_footer
?>
