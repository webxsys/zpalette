...
if (is_array($list_box_contents) > 0 )
	{
		...
		{ ?>
			<div id="featured-slider-inner" class="owl-carousel owl-theme">
			<?php
			for($row=0;$row<sizeof($list_box_contents);$row++)
				{
    				$params = "";
		...
		elseif($param4 == "itemcenterBoxContentsNew" && !$this_is_home_page)
		{ ?>
			<div id="new-slider-inner" class="owl-carousel owl-theme">
			<?php
			for($row=0;$row<sizeof($list_box_contents);$row++)
				{
    				$params = "";
		...
		{ ?>
			<div id="specials-slider" class="owl-carousel owl-theme">
			<?php
			for($row=0;$row<sizeof($list_box_contents);$row++)
				{
    				$params = "";
