...
<div class="product_info">
	<div class="row productinfo-container">
        ...
        <div id="product_info_display" class="col-md-7 col-sm-7 productinfo-rightwrapper col-xs-12"> 
            ...
            ?>
            <?php
                $display_qty = (($flag_show_product_info_in_cart_qty == 1 and $_SESSION['cart']->in_cart($_GET['products_id'])) ? '<div class="qty_in_cart">' . PRODUCTS_ORDER_QTY_TEXT_IN_CART . $_SESSION['cart']->get_quantity($_GET['products_id']) . '</div>' : '');
            	if ($products_qty_box_status == 0 or $products_quantity_order_max== 1) {
                    ...
                    $the_button = '<input type="hidden" name="cart_quantity" value="1" />' . zen_draw_hidden_field('products_id', (int)$_GET['products_id']) . zen_image_submit(BUTTON_IMAGE_IN_CART, BUTTON_IN_CART_ALT);
                		...
                		$the_button = '<strong>' . $quantity . '</strong><input type="text" class="quantity-input" name="cart_quantity" value="' . (zen_get_buy_now_qty($_GET['products_id'])) . '" maxlength="6" size="4" /><div class="sp-plus fff"><span class="ddd">+</span></div><div class="sp-minus fff"> <span class="ddd minus">-</span></div>'. zen_draw_hidden_field('products_id', (int)$_GET['products_id']).'<div class="cart_button">'.zen_image_submit(BUTTON_IMAGE_IN_CART, BUTTON_IN_CART_ALT).'</div>';
                        }
