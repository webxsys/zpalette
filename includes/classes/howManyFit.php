 ...
 /*   private function _installTables(){
  ...
  /*  private function _eraseTables(){
    ...
    public function getAllBrands()
    {
        global $db;
        $brand_array = array();
        $brand_query = "select * from howmanyfit_brand";
        $zp_brands = $db->Execute($brand_query);

        while(!$zp_brands->EOF){
            $brand_array[$zp_brands->fields['id_brand']] =  $zp_brands->fields['name'];
            $zp_brands->Movenext();
        }
        return $brand_array;
    }
    ...
    {
        global $db;
        $makeup_array = array(array());
        $makeup_query = "select * from howmanyfit_makeup";
