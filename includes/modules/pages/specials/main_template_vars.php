      ...
      $list_box_contents[$row][$col] = array('params' => 'class="specialsListBoxContents"',
									...
									<div class="productinfo-wrapper">
										<div class="product_image">
											 <a href="' . zen_href_link(zen_get_info_page($specials->fields['products_id']), 'cPath=' . zen_get_generated_category_path_rev($specials->fields['master_categories_id']) . '&products_id=' . $specials->fields['products_id']) . '">' . (($specials->fields['products_image'] == '' and PRODUCTS_IMAGE_NO_IMAGE_STATUS == 0) ? '' : zen_image(DIR_WS_IMAGES . $specials->fields['products_image'], $specials->fields['products_name'], IMAGE_PRODUCT_NEW_WIDTH, IMAGE_PRODUCT_NEW_HEIGHT) . '</a>'
											
											.'
												<div class="hover_info">
													<div class="zoom-button">
														<a data-toggle="tooltip" data-original-title="View Image" class="group1" href="' . DIR_WS_IMAGES . $specials->fields['products_image'] . '">' . '<i class="fa fa-eye fa-lg"></i></a>
													</div>
													<div class="detailbutton-wrapper">
														<a data-toggle="tooltip" data-original-title="Product Detail" href="' . zen_href_link(zen_get_info_page($specials->fields['products_id']), 'cPath=' . $productsInCategory[$specials->fields['products_id']] . '&products_id=' . $specials->fields['products_id']) . '"><i class="fa fa-link fa-lg"></i></a>
													</div>
												</div>
											</div>
