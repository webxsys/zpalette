...
define('HEADER_TITLE_MANUFACTURER','Brand');

// ---- db 3.22.16

define('HEADER_TITLE_EXPERIENCE','Experience');
define('HEADER_TITLE_SIZE_GUIDE','Size Guide');
define('HEADER_TITLE_INSPIRATION','Inspiration');
define('HEADER_TITLE_BLOG', 'Blog');

// ---- db 3.22.16

define('HEADER_TITLE_TOP_LEFT','We Ship Worldwide! + Free US Shipping over $60');
...
define('HEADER_TITLE_QUICK_CONTACT','Quick Contact');
