...
define('HEADING_PAGE_NOT_FOUND_404', '404');
define('HEADING_PAGE_NOT_FOUND_ERROR', 'error');
define('HEADING_PAGE_NOT_FOUND_PAGE', 'page');
define('HEADING_PAGE_NOT_FOUND_MESSAGE', 'The page cannot be found...');
?>