...
// javascript messages
  ...
  define('ENTRY_EMAIL_ADDRESS_CHECK_ERROR', '<button class="close" aria-hidden="true" data-dismiss="alert" type="button">×</button>Sorry, my system does not understand your email address. Please try again.');
  ...
  define('PREVNEXT_BUTTON_FIRST', '<i class="fa fa-angle-double-left"></i>');
  define('PREVNEXT_BUTTON_PREV', '<i class="fa fa-angle-double-left"></i>');
  define('PREVNEXT_BUTTON_NEXT', '<i class="fa fa-angle-double-right"></i>');
  define('PREVNEXT_BUTTON_LAST', '<i class="fa fa-angle-double-right"></i>');
...
// error on checkout when $_SESSION['customers_id' does not exist in customers table
  ...
  define('TABLE_HEADING_SPECIALS_INDEX', 'Specials Products');
...
// headings for products listing  
  define('TABLE_HEADING_QUANTITY_LISTING', 'In Stock: ');
  define('TEXT_OUT_OF_STOCK_LISTING', 'Out of Stock');
